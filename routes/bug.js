...
router.get('/:id', function(req, res, next){
  ...
  oracledb.getConnection(
    ...
    function(err, connection)
    {
      ...
      connection.execute(
        "SELECT b.bugno, b.summary, b.description, b.reporter, b.bugdate, b.phone, b.status, b.type, p.phonename, p.osver, e.empname from bug b, phone p, employee e where b.bugno='"+id+"' and b.reporter=e.empno and b.phone=p.phoneno",  // bind value for :id
        function(err, result)
        {
          if (err) { console.error(err.message); return; }
          console.log(result.rows);
